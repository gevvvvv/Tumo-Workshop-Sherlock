...
<body>
	...
	<div class="o"><hr><div id="a"></a><a href="gallery2.php"><img src="images/ruseye.png"></a><a href="gallery2.php"><img src="images/engeye.png"></a></div><br>
    <div id="b">
...
<?php
$photo_list = file('list2.txt', FILE_IGNORE_NEW_LINES);
...
foreach ($photo_list as $item)
{
	...
	echo "<img src='images/3season/$file' />";
}
