...
<body>
	...
	<div class="o"><hr><div id="a"></a><a href="gallery3.php"><img src="images/ruseye.png"></a><a href="gallery3.php"><img src="images/engeye.png"></a></div><br>
    <div id="b">
...
<?php
$photo_list = file('list3.txt', FILE_IGNORE_NEW_LINES);
...
foreach ($photo_list as $item)
{
	...
	echo "<img src='images/Sherlockoproblems/$file' />";
}
